...
export default function Header({ lastUpdate, onRefresh, refreshing, onOpenSidebar }) {
  return (
    <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-4 sm:px-6 py-4 sm:py-5 border-b border-border">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg sm:text-xl font-semibold text-slate-100 tracking-tight">DASHBOARD</h1>
          <p className="text-xs sm:text-sm text-muted flex items-center gap-1.5 flex-wrap">
            Visão geral e recomendações em tempo real
            <span
